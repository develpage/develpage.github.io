...
$(document).ready(function () {
    $('.burger').on('click', function () {
        $('.up').toggleClass('animT');
        $('.middle').toggleClass('animM');
        $('.bottom').toggleClass('animB');
        $('.menu').fadeToggle('0.3', 'linear');
    });
...
/*     $('.portfolio-link').hover(function () {
        $('.porfolio-img').ready(function () {
            $('.link-caption').width($('.porfolio-img').width());
            $('.left-portfolio-project-name').fadeToggle();

        });
    }); */
    

        $('.container .portfolio-link').mouseenter(function () {
        $('.porfolio-img').ready(function () {
            $('.link-caption').width($('.porfolio-img').width());
        });
            $('.green-block').css('transform','translateX(-50%)');
            $('.green-block p').css('opacity','0');
            $('.green-block h3').css('opacity','0');
            
        
    });
            $('.portfolio-link').mouseleave(function () {
            $('.green-block').css('transform','translateX(0)');
            $('.green-block p').css('opacity','1');
            $('.green-block h3').css('opacity','1');
